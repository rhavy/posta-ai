...
export default function ClientPosts({ posts }: Props) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            // Atualiza localPosts imediatamente
    ...
    const handleEdit = (id: string) => router.push(`/posts/edit/${id}?page=posts_create`);
                        ...
                        <CardHeader className={`flex justify-between items-start ${
                          post.titleAlignment === "center" ? "text-center" : "text-left"
                            ...
                            <div className="flex gap-2">
                                <Button size="sm" variant="outline" onClick={() => router.push(`/posts/view/${post.id}?page=posts_create`)}>
                                    Visualizar
                                </Button>
